...
- Use four bundled medical-aesthetic prompt collections for pre-treatment standard photos, post-treatment standard photos, post-treatment everyday photos, and consistency review.
...
See [Medical Aesthetic Prompt Library](/docs/overview/third-party-prompt-repositories) for the complete built-in list and responsible-use notes.
